...
//             object obj = new System.Runtime.InteropServices.VariantWrapper(dwData);
        ...
        private void btnAddUser_Click(object sender, EventArgs e)
        {
            ...
            // DisableDevice();
            // اگر تابع DisableDevice باید فعال شود، آن را از حالت کامنت خارج کنید

            int dwEnMachineID = cmbEMachineNum.SelectedIndex + 1;
            int dwBackupNum = Convert.ToInt32(cmbBackupNum.Text);
            int dwPrivilegeNum = cmbPrivilege.SelectedIndex;

            string strEnrollID = tbEnrollNum.TextLength == 0 ? "" : tbEnrollNum.Text;
            ...
            {
                // بررسی کنید که آیا کتابخانه به درستی اضافه شده است یا خیر
                labelInfo.Text = $"Error: Method not found - {ex.Message}";
            }
            catch (Exception ex)
            {
                // برای خطاهای دیگر
        ...
        private void btnSetUserProfile_Click(object sender, EventArgs e)
        {
            DisableDevice();
            int dwEnMachineID = cmbEMachineNum.SelectedIndex + 1;
            int dwEnrollNum = Convert.ToInt32(tbEnrollNum.Text);
            ...
            bool bRet = pOcxObject.SetUserProfile(0,
              m_nMachineNum,
              dwEnrollNum,
              dwEnMachineID,
              ref obj
        ...
        private void btnGetUserProfile_Click(object sender, EventArgs e)
        {
            ...
            bool bRet = pOcxObject.GetUserProfile(0,
                m_nMachineNum,
                dwEnrollNum,
                dwEnMachineID,
                ref obj
        ...
        private void btnEnableUser_Click(object sender, EventArgs e)
        {
            ...
            bRet = pOcxObject.EnableUser(m_nMachineNum,
                dwEnrollNum,
                dwEnMachineID,
                dwBackupNum,
                1);
        ...
        private void btnDisEnableUser_Click(object sender, EventArgs e)
        {
            DisableDevice();
            int dwEnMachineID = cmbEMachineNum.SelectedIndex + 1;
            int dwEnrollNum = Convert.ToInt32(tbEnrollNum.Text);
